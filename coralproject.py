...
file_path = "/Users/vythu/Documents/Coral Project /global_bleaching_environmental.csv"
...
plt.title('Bleaching at 0–5m (2019–2020)')
...
plt.title('Bleaching Over Time (0–5m)')
...
# 7. Bản đồ nhiệt không gian dựa trên tọa độ Kinh độ/Vĩ độ
plt.figure(figsize=(10, 6))
sns.scatterplot(
    data=df_filtered,
    x='Longitude_Degrees',
